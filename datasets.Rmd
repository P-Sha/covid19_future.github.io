...
load("./influenza_us_cases.rda")
load("./influenza_global_cases.rda")
load("./h1n1_us_cases.rda")
load("./h1n1_global_cases.rda")
load("./h1n1_us_deaths.rda")
load("./h1n1_global_deaths.rda")
load("./covid19_chicago_df.rda")
