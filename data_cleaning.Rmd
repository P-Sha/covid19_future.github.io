...
#### SARS-CoV-1 Global (by countries)
...
>>>>>>> b88946ad23245d90e634ae1003f8cd3c92d9bce1
  clean_names() %>% 
...
<<<<<<< HEAD
save(covid19_chicago, file = "covid19_chicago.rda")
=======
save(covid19_chicago_df, file = "rdas/covid19_chicago_df.rda")
>>>>>>> b88946ad23245d90e634ae1003f8cd3c92d9bce1
```
...
save(global_cases, file = "global_cases.rda")
```
...
save(global_deaths, file = "global_deaths.rda")
```
...
save(us_cases, file = "us_cases.rda")
```
