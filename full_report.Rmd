...
Any report on pandemics in incomplete without the analysis of the basic Reproductive rate, also called R0 (R naught). Prior to this pandemic, it was probably heard for the first time by many in the movie [Contagion](imdb.com/title/tt1598778/). 

A measure of how many cases a single infected individual can generate in a susceptible population, it helps quantify an outbreak's intensity.
...
Comparison of the current COVID-19 pandemic with prior viral respiratory pathogen outbreaks reveal the severity of the current outbreak in terms of both global and US-specific incident cases and mortality burden.
