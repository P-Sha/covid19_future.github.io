...
<<<<<<< HEAD
<figure>
![](pictures/global_new_ vs_cumulative_cases_log.file)
<figcaption> New and Cumulative cases of pandemics worldwide, log-scaled to better depict comparisons.   </figcaption>
</figure>
=======
```{r covid19 cool plot}
